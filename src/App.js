...
import { TambahLab } from './screens/TambahLab';
				...
				<div className="App">
					<nav className="navbar navbar-expand-sm navbar-dark bg-dark">
						...
						<div className="collapse navbar-collapse">
							<ul className="navbar-nav mr-auto">
								...
								<li className='nav-item'>
									<NavLink to="/all-staff-farmasi" exact className="nav-link" activeClassName="active">Staff Farmasi</NavLink>
								</li>
							</ul>
						</div>
					</nav>
					...
					<div className="container">
						<Switch>
							...
							<Route path="/tambah-lab-pasien/:id" exact component={TambahLab} />
						</Switch>
					</div>
				</div>
			</Router>
